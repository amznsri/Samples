...
if user_input:
    ...
    with st.spinner("Processing your article..."):
        try:
            ...
            # Generate summary
            summary_points = summarizer.summarize_article(user_input)
            ...
            with col2:
                ...
                st.image(infographic_url, caption=article_title, use_column_width=True)
                # Remove the download link from here
            ...
            response_content = f"### Article Summary\n\n" + "\n\n".join([f"• {point}" for point in summary_points])
